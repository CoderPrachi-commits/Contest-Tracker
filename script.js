// // storing contests so i dont fetch again when filtering
// let allContests = []
// let selectedPlatform = 'ALL'

// // platforms i want to show in filter
// // got these names by checking what clist api returns in resource field
// const platforms = ['ALL', 'codeforces.com', 'leetcode.com', 'codechef.com', 'atcoder.jp', 'hackerearth.com', 'hackerrank.com']
...
// // clist gives all platforms in one call which is why i used it
// function getContests() {
//   document.getElementById('upcomingGrid').innerHTML = '<p class="loader">Loading...</p>'
//   document.getElementById('pastGrid').innerHTML = ''

//   // getting upcoming and past contests both
//   // limit 100 so we get enough contests
//  fetch('https://clist.by/api/v1/json/contest/?username=dt_coder&api_key=8b89a22f5ea2c11ef10bb9b96c74137b8b105191&limit=100&format=json&order_by=start&start__gte=2025-05-22')
//     .then(function(res) {
//       return res.json()
//     })
//     .then(function(data) {
//       console.log('data came', data)
//       allContests = data.objects
...
//     // cleaning up platform name for button text
//     if (platform === 'ALL') {
//       btn.textContent = 'ALL'
//     } else {
...
// // separating contests into upcoming and past then showing them
// function showContests(contests) {
//   const now = new Date().getTime()

//   // filtering by selected platform first
//   let filtered = contests

//   if (selectedPlatform !== 'ALL') {
//     filtered = contests.filter(function(c) {
//       return c.resource && c.resource.name === selectedPlatform
//     })
//   }

//   // now separate upcoming and past
//   // clist gives start and end as strings so converting to date
//   let upcoming = filtered.filter(function(c) {
//     return new Date(c.end).getTime() > now
//   })

//   let past = filtered.filter(function(c) {
//     return new Date(c.end).getTime() <= now
//   })

//   // only showing 20 past contests otherwise page gets too heavy
...
//   // showing upcoming cards
//   const upcomingGrid = document.getElementById('upcomingGrid')
//   upcomingGrid.innerHTML = ''

//   if (upcoming.length === 0) {
//     upcomingGrid.innerHTML = '<p class="no-contests">No upcoming contests</p>'
//   } else {
//     upcoming.forEach(function(contest) {
//       upcomingGrid.appendChild(makeCard(contest, false))
//     })
//   }
...
//   if (past.length === 0) {
//     pastGrid.innerHTML = '<p class="no-contests">No past contests</p>'
//   } else {
//     past.forEach(function(contest) {
//       pastGrid.appendChild(makeCard(contest, true))
//     })
//   }
// }

// // making one contest card
// function makeCard(contest, isPast) {
//   const card = document.createElement('div')
//   card.classList.add('card')

//   // clist gives start time as string like "2024-03-15T10:00:00"
...
//   // getting platform name from resource
//   const platformName = contest.resource ? contest.resource.name : 'Unknown'
...
//   // unique id for countdown
//   const countdownId = 'cd-' + contest.id

//   // youtube search for editorials
//   const youtubeLink = 'https://www.youtube.com/results?search_query=' + encodeURIComponent(contest.event + ' editorial')

//   // google calendar link
//   const calendarLink = makeCalendarLink(contest)

//   // buttons based on past or upcoming
//   let buttons = ''
//   if (isPast) {
//     buttons = `
//       <a href="${contest.href}" target="_blank" class="btn-join">View Contest</a>
//       <a href="${youtubeLink}" target="_blank" class="btn-youtube">▶ Editorial</a>
//     `
//   } else {
//     buttons = `
//       <a href="${contest.href}" target="_blank" class="btn-join">Join Contest</a>
//       <a href="${calendarLink}" target="_blank" class="btn-calendar">+ Calendar</a>
//     `
//   }

//   card.innerHTML = `
//     <div class="badge-row">
//       <span class="badge-platform">${platformName}</span>
//       ${statusBadge}
//     </div>
...
//     </div>
//     <div class="countdown-row" id="${countdownId}"></div>
...
//   if (!isPast) {
//     startCountdown(contest.start, contest.end, countdownId)
//   }
...
//     // stop timer if card is gone from page
//     if (!el) {
...
//     html += `<span class="countdown-box">${hours}h</span>`
//     html += `<span class="countdown-box">${mins}m</span>`
//     html += `<span class="countdown-box">${secs}s</span>`
...
// // making google calendar link
// function makeCalendarLink(contest) {
